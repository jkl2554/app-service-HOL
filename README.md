...
# HOL 목차
[1. Web App 생성 및 게시](#Web-App-생성-및-게시)  
>   [1.1. Azure Web App 생성](#Azure-Web-App-생성)  
    [1.2. MySQL In App 생성](#MySQL-In-App-생성)  
    [1.3. 배포 설정](#MySQL-In-App-생성)  
    [1.4. FTP 배포](#FTP-배포)  
    [1.5. Git 배포](#Git-배포)  
    [1.6. 샘플 앱 빌드](#샘플-앱-빌드)  
    [1.7. 앱 구성 설정](#앱-구성-설정)  

[2. Production 구성](#Production-구성)  
>   [2.1 배포 슬롯 생성](#배포-슬롯-생성)  
    [2.2 Production DB 생성](#Production-DB-생성)  
    [2.3 앱 구성으로 Production DB 연결](#앱-구성으로-Production-DB-연결)  
    [2.4 MySQL In App DB Export 작업](#MySQL-In-App-DB-Export-작업)  
    [2.5 App Service 편집기로 DB SSL 연결 구성](#App-Service-편집기로-DB-SSL-연결-구성)  

[3. Visual Studio Code & App Service](#Visual-Studio-Code-&-App-Service)  
>   [3.1 Visual Studio Code를 통해 배포 슬롯에 배포](#Visual-Studio-Code를-통해-배포-슬롯에-배포)  
    [3.2 Visual Studio Code로 Swap Slot](#Visual-Studio-Code로-Swap-Slot)  

[4. Traffic Manager](#Traffic-Manager)  
>   [4.1 앱 복제를 통해 다른 지역에 배포](#앱-복제를-통해-다른-지역에-배포)  
    [4.2 Traffic Manager 생성](#Traffic-Manager-생성)  
    [4.3 Traffic Manager 설정](#Traffic-Manager-설정)  

[5. Web App VNet 통합](#Web-App-VNet-통합)  
>   [5.1 Azure 가상 네트워크 생성](#Azure-가상-네트워크-생성)  
    [5.2 Web App VNet 통합 구성](#Web-App-VNet-통합-구성)  
    [5.3 DB 서비스 엔드포인트를 통해 VNet 통합 확인](#DB-서비스-엔드포인트를-통해-VNet-통합-확인)  
[6. 리소스 정리](#리소스-정리)    
